...
const UpdateReviewItem = () => {
  ...
  const { reviewUpdate, reviewUpdateLoading } = useUpdateReview();
      ...
      reviewUpdate(
        ...
        },
        {
          onSuccess: () => {
            ...
            successNotify(`You have updated a review for ${data?.name}`);
      ...
      <>
        <div className="relative mx-auto flex max-w-[500px] flex-col items-center gap-8 rounded-lg px-5 py-20 tablet:mx-0 tablet:min-w-[900px] tablet:bg-game-info tablet:px-8 tablet:py-8">
          ...
          >
            ...
            >
              {reviewUpdateLoading ? <SmallSpinner color="black" /> : "Update"}
            </button>
          </form>
...
export default UpdateReviewItem;
